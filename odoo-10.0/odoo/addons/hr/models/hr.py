...
class Job(models.Model):
    ...
    name = fields.Char(string='Training Title', required=True, index=True, translate=True)
    expected_employees = fields.Integer(compute='_compute_employees', string='Total Forecasted Trainer', store=True,
        help='Expected number of employees for this job position after new recruitment.')
    no_of_employee = fields.Integer(compute='_compute_employees', string="Current Number of Trainer", store=True,
        help='Number of employees currently occupying this job position.')
    no_of_recruitment = fields.Integer(string='Expected New Trainer', copy=False,
        help='Number of new employees you expect to recruit.', default=1)
    no_of_hired_employee = fields.Integer(string='Registered Trainer ', copy=False,
    ...
    state = fields.Selection([
        ('recruit', 'Registration in Progress'),
        ('open', 'Un Approved Registration')
...
class Employee(models.Model):
    ...
    job_id = fields.Many2one('hr.job', string='Training Title')
