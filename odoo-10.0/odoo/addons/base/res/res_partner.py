...
class Partner(models.Model, FormatAddress):
    ...
    type = fields.Selection(
        [('contact', 'Company Owner'),
         ...
         ('delivery', 'General Manager address'),
         ('other', 'Other address'),
    ...
    cut_flowe = fields.Char(String='Mjn')
    # cut_flower = fields.Char(String='Cut Flower In Hectars')
    fruit_business = fields.Char(String='Fruit In Hectars')
    vegetables_business = fields.Char(String='Vegetables In Hectars ')
    herbs_business = fields.Char(String='Herbs In Hectars')
    not_underproduction_business = fields.Char(String='Area Not Under Production In Hectars')
