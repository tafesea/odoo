...
class RecruitmentStage(models.Model):
    ...
    job_id = fields.Many2one('hr.job', string='Training Specific',
                             ondelete='cascade',
...
class Applicant(models.Model):
    ...
    date_interst = fields.Char("Date Of Interste")
    ...
    job_id = fields.Many2one('hr.job', "Applied Training")
    ...
    def onchange_partner_id(self):
        ...
        self.date_interst_from = self.partner_id.date_interst
