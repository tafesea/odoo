...
class Project(models.Model):
    ...
    label_tasks = fields.Char(string='Use Tasks as', default='KPI', help="Gives label to tasks on project's kanban view.")
    ...
    task_count = fields.Integer(compute='_compute_task_count', string="KPI")
...
class Task(models.Model):
    ...
    project_id = fields.Many2one('project.project',
        ...
        track_visibility='onchange',
        change_default=True)
    department_id = fields.Many2one('hr.department',string='Component')
    notes = fields.Text(string='Notes')
    planned_hours = fields.Float(string='Target', help='Estimated time to do the task, usually set by the project manager when the task is in draft state.')
    remaining_hours = fields.Float(string='Remaining Target', digits=(16,2), help="Total remaining time, can be re-estimated periodically by the assignee of the task.")
